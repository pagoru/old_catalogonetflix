<head>
	<title id="title"><?php echo NAME_WEB;?></title>
	...
	<meta name="twitter:site" 			content="@CatalogoNetflix">
	<meta name="twitter:creator" 		content="@CatalogoNetflix">
	<meta name="twitter:title"			content="<?php echo NAME_WEB;?>">
